...
Cayley map is a diffeomorphism onto a dense open subset of $\mathrm{U}(n)$, and
gradients through it were finite in all experiments.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.55\linewidth]{figs/fig_disentanglement.png}
...
val $3.46$), while every constrained variant holds val $\approx 1.51$: the
identity-initialized stream topology warms up capacity gradually.
...
verified empirically ($10^{-11}$ vs.\ $0.99$). Future work: token-conditional phases and scaling studies.
